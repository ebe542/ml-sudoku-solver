...
def test_feature_contains_candidate_interactions() -> None:
    ...
    interaction_features = features[:, 91:118]

    assert interaction_features.shape[1] == 27
    assert np.all(interaction_features >= 0)
